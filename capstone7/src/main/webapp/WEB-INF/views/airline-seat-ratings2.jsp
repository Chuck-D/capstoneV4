							...
							<div class="single-destinations">
								...
								<div class="details">
									...
									<ul class="package-list">
										<li class="d-flex justify-content-between align-items-center">
											<span>Seat Comfort</span>
											<span><fmt:formatNumber type="number" maxFractionDigits="1" value="${DeltaComfortSum/American.size()}"/></span>
										</li>
										<li class="d-flex justify-content-between align-items-center">
											<span>Legroom</span>
											<span><fmt:formatNumber type="number" maxFractionDigits="1" value="${DeltaLegroomSum/American.size()}"/></span>
										</li>
										<li class="d-flex justify-content-between align-items-center">
											<span>Wi-fi</span>
											<span>Yes</span>
							...
							<div class="single-destinations">
								...
								<div class="details">
									<h4 class="d-flex justify-content-between">
										<span>Hawaiian</span>                              	
										<div class="star">
											<c:if test="${Hawaiian/2 >= 1}">
											<span class="fa fa-star checked"></span></c:if>	
										<c:if test="${Hawaiian/2 < 1}">	
											<span class="fa fa-star"></span></c:if>
										<c:if test="${Hawaiian/2 >= 1.5 && Hawaiian/2<2}">
										 	<span class="fa fa-star-half checked"></span></c:if>
											
										<c:if test="${Hawaiian/2>= 2}">
											<span class="fa fa-star checked"></span></c:if>	
										<c:if test="${Hawaiian/2 < 2}">	
											<span class="fa fa-star"></span></c:if>
										<c:if test="${Hawaiian/2 >= 2.5 && Hawaiian/2 <3}">
										 	<span class="fa fa-star-half checked"></span></c:if>
										 	
										<c:if test="${Hawaiian/2 >= 3}">
											<span class="fa fa-star checked"></span></c:if>	
										<c:if test="${Hawaiian/2 < 3}">	
											<span class="fa fa-star"></span></c:if>
										<c:if test="${Hawaiian/2 >= 3.5 && Hawaiian/2<4}">
										 	<span class="fa fa-star-half checked"></span></c:if> 
										 	
										<c:if test="${Hawaiian/2 >= 4}">
											<span class="fa fa-star checked"></span></c:if>	
										<c:if test="${Hawaiian/2< 4}">	
											<span class="fa fa-star"></span></c:if>
										<c:if test="${Hawaiian/2 >= 4.5 && Hawaiian/2<5}">
										 	<span class="fa fa-star-half checked"></span></c:if>  		
											
										<c:if test="${Hawaiian/2 >= 5}">
											<span class="fa fa-star checked"></span></c:if>	
										<c:if test="${Hawaiian/2< 5}">	
											<span class="fa fa-star"></span></c:if>					
										</div>	
									...
									<ul class="package-list">
										<li class="d-flex justify-content-between align-items-center">
											<span>Seat Comfort</span>
											<span><fmt:formatNumber type="number" maxFractionDigits="1" value="${HawaiianComfortSum/American.size()}"/></span>
										</li>
										<li class="d-flex justify-content-between align-items-center">
											<span>Legroom</span>
											<span><fmt:formatNumber type="number" maxFractionDigits="1" value="${HawaiianLegroomSum/American.size()}"/></span>
										</li>
										<li class="d-flex justify-content-between align-items-center">
											<span>Wi-fi</span>
											<span>Yes</span>
							...
							<div class="single-destinations">
								...
								<div class="details">
									...
									<ul class="package-list">
										<li class="d-flex justify-content-between align-items-center">
											<span>Seat Comfort</span>
											<span><fmt:formatNumber type="number" maxFractionDigits="1" value="${FrontierComfortSum/American.size()}"/></span>
										</li>
										<li class="d-flex justify-content-between align-items-center">
											<span>Legroom</span>
											<span><fmt:formatNumber type="number" maxFractionDigits="1" value="${FrontierLegroomSum/American.size()}"/></span>
										</li>
										<li class="d-flex justify-content-between align-items-center">
											<span>Wi-fi</span>
											<span>Yes</span>
